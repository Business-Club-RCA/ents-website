...
export function PageHero({ kicker, title, description, children }: PageHeroProps) {
  return (
    <section className="relative w-full min-h-[48vh] sm:min-h-[55vh] lg:min-h-[62vh] flex flex-col justify-end overflow-hidden bg-[#0e0e11] text-white select-none border-b border-neutral-800">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-x-0 top-0 h-36 bg-gradient-to-b from-[#0e0e11]/80 via-[#0e0e11]/40 to-transparent pointer-events-none" />

        {/* Bottom Deep Vignette for Text Legibility */}
        <div className="absolute inset-x-0 bottom-0 h-full bg-gradient-to-t from-[#0e0e11] via-[#0e0e11]/60 to-transparent pointer-events-none" />
      </div>

      {/* 2. Hero Content with Smooth Staggered Animations */}
      <div className="relative z-10 w-full pt-28 sm:pt-32 pb-12 sm:pb-16 lg:pb-20">
        <Container size="wide">
          <div className="max-w-3xl space-y-4">
            ...
            <h1 className="animate-hero-word-1 text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-white leading-[1.08]">
              {title}
            </h1>
